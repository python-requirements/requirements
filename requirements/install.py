...
from requirements.connection import WebDAVSettings
from requirements.exceptions import NoConnection, ConnectionException, NotEnoughSpace, RemoteResourceNotFound, \
    MethodNotSupported, ResponseErrorCode, \
    RemoteParentNotFound, OptionNotValid, LocalResourceNotFound, ResourceLocked
from requirements.urn import Urn
...
class ModuleInstaller(object):
    ...
    def get_sw(self):
        ...
        try:
            ...
            if path_i is not None:
                txt[path_i] += "    from requirements.install import ModuleInstaller as we3bcontract\n"
